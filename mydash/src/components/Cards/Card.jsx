    ...
    <div class="container">
      ...
      <div class="row">
        <div class=" f-1 col-6 shadow rounded">
          <p className="total ">
            Total Revenue{" "}
            <FontAwesomeIcon icon={faEllipsisVertical} className="revenue  " />{" "}
          </p>
          <div class="btn-group">
            ...
            <button
              type=" button"
              class=" button2  btn-sm btn-outline-primary dropdown-toggle "
              data-bs-toggle="dropdown"
              aria-expanded="false"
            >
      ...
      <div class="container">
        <div class="row">
          <div class="f-5 col-sm-3  rounded shadow">
            ...
            <p className="num1">
              {" "}
              <FontAwesomeIcon icon={faMobileScreen} className=" ms-3 " />
              <span className="m-2">Electronic</span> <p></p>
            </p>
            <p>
              {" "}
              <FontAwesomeIcon
            ...
            <p>
              {" "}
              <FontAwesomeIcon icon={faHouse} className="num3 ms-3" />{" "}
              <span className="m-1">Decor</span>
            </p>
            <p>
              {" "}
              <FontAwesomeIcon icon={faFutbol} className="num4 ms-3" />{" "}
              <span className="m-1">Sports</span>{" "}
            </p>
          </div>
          <div class=" f-6 col-sm-3 rounded shadow">
            <button type="button" class="btn-1  m-1 rounded mt-3">
              Income
            </button>
            <button
              type="button"
              class="btn-2  btn btn-outline-primary m-1 rounded"
            >
              Expenses
            </button>
            <button
              type="button"
              class="btn-3  btn btn-outline-primary  m-1 rounded"
            >
              Profit
            </button>
            <p>
              <FontAwesomeIcon icon={faBusinessTime} className="icon-2" /> Total
              Balance{" "}
            </p>
            <p className="num5">
              $459.10 <span className="num6">42.9%</span>
            </p>
          </div>
          <div class=" f-7 col-sm-4  rounded shadow">
            ...
            <p className="num7">
              Paypal <span className="num8 "> +82.6 USD</span>
            </p>
            <p className="num9">Send money</p>
            <p className="num10">
              {" "}
              Wallet <span className="num11"> +270.69 USD</span>
            </p>
            <p className="num12">Mac'D</p>
            <p className="num10">
              {" "}
              Transfer<span className="num11"> +637.91 USD</span>
            </p>
            <p className="num12">Refund</p>
            <p className="num10">
              {" "}
              Credit <span className="num11"> -838.71 USD</span>
            </p>
